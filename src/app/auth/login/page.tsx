      ...
      <div className="w-full max-w-md border border-white/10 rounded-xl p-8 bg-white/5">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="w-full py-3 px-4 bg-white text-gray-900 rounded-lg font-semibold transition hover:bg-gray-100 disabled:opacity-50 flex items-center justify-center gap-3"
          >
          ...
          <button
            ...
            disabled={oauthLoading !== null}
            className="w-full py-3 px-4 bg-gray-800 text-white rounded-lg font-semibold transition hover:bg-gray-700 disabled:opacity-50 flex items-center justify-center gap-3 border border-white/10"
          >
